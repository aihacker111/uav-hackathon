    ...
    def __init__(self):
        ...
        self.parser.add_argument('--arch',
                                 ...
                                 help='model architecture. Currently tested'
                                      ...
                                      'deimv2 (DINOv3STAs + HybridEncoder + CenterNet heads)')
        ...
        # DEIMv2-specific: path to the full DEIMv2 COCO pretrained checkpoint
        # (backbone+encoder weights will be extracted; CenterNet heads fine-tuned)
        self.parser.add_argument('--deimv2_pretrained',
                                 default='',
